...
class UI_QS_01(unittest.TestCase):
    ...
    def test_change_2g_pw(self):
        ...
        driver.get(expected_quick_setup)
        time.sleep(3)
        self.assertEqual(actual_password, keys_send, '[UI_QS_01] Change password fail in IE')
