...
class PageLogin(unittest.TestCase):
    ...
    def test_UI_LG_03(self):
        ...
        driver.maximize_window()
        driver.execute_script('''document.title="''' + self._testMethodName + '''"''')
        self.assertNotEqual(ipv6_global, 'http://[unknown]', '[UI_LG_03] IPv6 global is not existed')
    ...
    #     sample_input = '\; ls -l\;'
    #     for i in range(1, 6):
    #         Helper.Helper_common.test_login(driver, self, ipv6, user=sample_input, pass_word=sample_input)
    #         time.sleep(1)
    #         # Check red error
    #         error = driver.find_elements_by_css_selector('.f-wrap.error')
    #         try:
...
class PageNetworkDHCPv6(unittest.TestCase):
    ...
    def test_UI_NDv6_08(self):
        ...
        number_addr = driver.find_element_by_css_selector('#numero-de-endereĂ§os').get_attribute('value')
...
class PageWifiPrimaryNetwork(unittest.TestCase):
    ...
    def test_UI_WPN_10(self):
        ...
        api = Helper.Helper_common.call_get_api_genaeral('/api/v1/wifi/0/ssid/0')
        actual = [api['active'],
                  api['security']['type'],
        ...
        api = Helper.Helper_common.call_get_api_genaeral('/api/v1/wifi/wps?interfaceId=0')
        actual = [api['active']]
        expected = [True]
        try:
            self.assertListEqual(actual, expected)
...
class PageAdminRouterPassword(unittest.TestCase):
    ...
    def test_UI_ARP_01(self):
        ...
        self.assertLessEqual(count_time, 300, 'Pop-up change PW was timeout > 5 minutes')
        #
        os.system('python run_start_hga20r.py COM5 COM6')
        # os.system(
