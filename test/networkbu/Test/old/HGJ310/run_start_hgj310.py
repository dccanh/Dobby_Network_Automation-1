...
def run_start(rg, cm):
    ...
    os.system(
            '"C:\Program Files\VanDyke Software\SecureCRT\SecureCRT.exe" /SCRIPT ./get_info_hgj310_1.py /SERIAL ' + str(rg.upper()) + ' /BAUD 115200')
    time.sleep(1)
    os.system(
            '"C:\Program Files\VanDyke Software\SecureCRT\SecureCRT.exe" /SCRIPT ./get_info_hgj310_2.py /SERIAL ' + str(cm.upper()) + ' /BAUD 115200')
